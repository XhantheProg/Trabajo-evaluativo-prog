...
public class pelicula {
        ...
        // Método público para imprimir los valores de los atributos
        ...
        // Método privado para determinar si es una película épica
        private boolean esPeliculaEpica() {
            return duracion >= 180; // 180 minutos equivale a 3 horas
        }

        // Método privado para calcular la valoración
        ...
        private void imprimirCartel() {
            ...
            int numAsteriscos = (int) (calificacion / 2); // Convertir calificación a asteriscos
